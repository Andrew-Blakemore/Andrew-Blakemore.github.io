...
│   └── js/
│       ├── engineering-repair-carousel.js
│       ├── itinerary-story.js
│       ├── keegan-map.js
...
- `assets/js/engineering-repair-carousel.js`

### Itinerary field reports

Itinerary page content lives in `_pages/keegan-itinerary/`. The reusable field-report blocks and responsive presentation are maintained in `_sass/_custom.scss`; shared visit-switching behavior lives in `assets/js/itinerary-story.js` and is loaded by `_layouts/itinerary.html`.
...
- Preserved experimental prosthetic hero animation: `assets/js/keegan-prosthetic-hero.js`
