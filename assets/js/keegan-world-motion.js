document.addEventListener("DOMContentLoaded", async () => {
  ...
  function drawGlobe() {
    ...
    ocean.addColorStop(0, "#315665");
    ocean.addColorStop(0.62, "#1b3440");
    ocean.addColorStop(1, "#101e25");
    ...
    context.strokeStyle = "rgba(174, 214, 229, 0.2)";
    ...
    countries.forEach((feature) => {
      context.fillStyle = "rgba(80, 142, 166, 0.42)";
      context.strokeStyle = "rgba(177, 218, 232, 0.56)";
    ...
    context.strokeStyle = "rgba(111, 184, 211, 0.94)";
    ...
    itinerary.slice(0, visibleStopCount).forEach((stop) => {
      ...
      context.fillStyle = "#8dd4ec";
      context.shadowColor = "rgba(87, 176, 209, 0.68)";
    ...
    context.strokeStyle = "rgba(187, 222, 234, 0.56)";
    context.stroke();
  }
