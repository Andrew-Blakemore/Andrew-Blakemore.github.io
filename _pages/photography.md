...
<section class="photography-gallery-shell" aria-label="Photography gallery">
  ...
  <div class="photography-divider" aria-hidden="true"></div>
  ...
  <aside class="photography-instagram" aria-labelledby="photography-instagram-title">
    ...
    <a
      class="photography-instagram__link"
      href="https://www.instagram.com/ablkmr_visuals/"
      target="_blank"
      rel="noopener noreferrer me"
      aria-label="View Andrew Blakemore's photography on Instagram"
    >
      <i class="fab fa-instagram" aria-hidden="true"></i>
      <span>
        <strong>View on Instagram</strong>
        <small>@ablkmr_visuals</small>
      </span>
      <i class="fas fa-arrow-right photography-instagram__arrow" aria-hidden="true"></i>
    </a>
  </aside>
</section>
...
<script>
  ...
  function applyFilter(filter) {
    ...
    // Let the reset opacity render before restarting the reveal animation.
    if (visibleItems.length > 0) {
      void visibleItems[0].offsetWidth;
    }
