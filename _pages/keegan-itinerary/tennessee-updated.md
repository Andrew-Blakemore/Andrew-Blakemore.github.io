...
<p class="itinerary-story__dek">
    ...
    <nav class="itinerary-story__index itinerary-story__visit-index" aria-label="Tennessee visits and experiences" data-itinerary-visit-nav>
    ...
    <div class="itinerary-story__visit-profiles" data-itinerary-visit-group>
      <section class="itinerary-story__visit-profile" id="fabco-visit" data-itinerary-visit="fabco">
  ...
  <div class="itinerary-story__visit-content" data-itinerary-visit="fabco">
  ...
  <section class="itinerary-story__section itinerary-story__section--opening">
    <div class="itinerary-story__opening-copy">
      ...
      <p>
        <em>Designed for Living</em> explores how prostheses shape everyday life, but I realized pretty quickly that I first needed to understand how one gets made. When a prosthetist decides what a socket should look like, what actually happens between that decision and the moment a finished socket comes back to the clinic? At FabCo, I followed that question onto the fabrication floor.
      </p>
      <p>
        FabCo is a prosthetics-only central fabrication facility in Nashville. Clinics send casts or digital files, diagnostic sockets, and detailed instructions; FabCo's technicians turn that clinical information into a physical device and send it back. Walking through the building made the word <em>custom</em> feel much more literal. A socket may ultimately look like one object, but getting there can involve plaster model preparation, thermoforming, lamination, machining, finishing, and assembly spread across several rooms and several kinds of expertise.
      </p>
    </div>
  </section>
  ...
  <section class="itinerary-story__section">
    <div>
      <h2>What Happens After the Cast Leaves the Clinic?</h2>
      <p>
        I had previously thought of socket fabrication mostly as something the prosthetist did. FabCo made the handoff in that process visible. A typical lower-limb pathway begins with a model of the patient’s residual limb anatomy that has been <em>rectified</em>—modified to create relief in sensitive areas and support where the clinician wants the socket to load the body.
  ...
  <div
    ...
    data-single-photo-carousel
    aria-label="Socket fabrication photographs"
  >
    <button
      class="single-photo-carousel__button single-photo-carousel__button--previous"
      type="button"
    ...
    <button
      class="single-photo-carousel__button single-photo-carousel__button--next"
      type="button"
      aria-label="Show next socket fabrication photograph"
    ><i class="fas fa-chevron-right" aria-hidden="true"></i></button>

    <div class="single-photo-carousel__dots" role="group" aria-label="Choose a socket fabrication photograph">
      ...
      <button class="single-photo-carousel__dot" type="button" data-single-photo-dot="3" aria-label="Show photograph 4"></button>
    </div>
  </div>
  ...
  <div class="itinerary-story__feature itinerary-story__feature--uncropped">
    ...
    <div class="itinerary-story__process-note">
      <h3>One Device, One Set of Eyes</h3>
      <p>
        I expected something closer to an assembly line. Instead, the work I observed was usually organized around continuity: rather than handing a socket to a new person at every station, Each job was primarily assigned to one
  ...
  <section class="itinerary-story__section">
    <div>
      ...
      <p>
        Following the same device across the shop changed the way I thought about fabrication. The drawings, measurements, and written procedures matter, but they cannot capture every judgment a technician makes along the way. Throughout the morning,
  ...
  <section class="itinerary-story__section">
    <div>
      <h2>New Technology Still Has to Earn Its Place</h2>
      <p>
        I went into FabCo particularly curious about digitization and 3D printing. What I found was less a story of old techniques being replaced than of new tools having to prove that they are actually better at a particular job. The facility has adopted faster carving
  ...
  <section class="itinerary-story__section">
    <div>
      <h2>The Socket Is One Object. Its Making Is a Network.</h2>
      <p>
        By the end of the visit, the biggest change in my thinking had little to do with carbon fiber or thermoforming. FabCo felt much less like a standalone fabrication facility and more like one node in a national network. The team knew prosthetists I had
  ...
  <div class="itinerary-story__visit-profiles itinerary-story__visit-profiles--future" data-itinerary-visit-group hidden>
    <section class="itinerary-story__visit-profile itinerary-story__visit-profile--future" id="abr-visit" data-itinerary-visit="abr" hidden>
      <dl class="itinerary-story__facts">
        <div>
          <dt>Organization</dt>
    ...
    <section class="itinerary-story__visit-profile itinerary-story__visit-profile--future" id="fillauer-visit" data-itinerary-visit="fillauer" hidden>
      <dl class="itinerary-story__facts">
        <div>
          <dt>Organization</dt>
          <dd>Fillauer</dd>
