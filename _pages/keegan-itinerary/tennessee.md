...
<div class="itinerary-story itinerary-story--tennessee">
  <header class="itinerary-story__intro">
    ...
    <p class="itinerary-story__dek">
      ...
      Tennessee offers an unusually compact cross-section of the field:
      nationwide central fabrication and adaptive-sport work in Nashville,
      together with a long-established prosthetic manufacturer in Chattanooga.
      These field notes follow how decisions move among workshops, component
      makers, clinicians, and the people who ultimately live with the devices.
    </p>
    ...
    <div class="itinerary-story__visit-profiles">
      <section class="itinerary-story__visit-profile" id="fabco-visit">
        <dl class="itinerary-story__facts">
          ...
          <div>
            <dt>Field-note focus</dt>
            <dd>Socket fabrication &amp; workshop knowledge</dd>
          </div>
        </dl>
        <p class="itinerary-story__visit-status">Visited August 3, 2026</p>
      </section>
  ...
  <div class="itinerary-story__visit-profiles itinerary-story__visit-profiles--future">
    <section class="itinerary-story__visit-profile itinerary-story__visit-profile--future" id="abr-visit">
      <dl class="itinerary-story__facts">
        ...
        <div>
          <dt>Field-note focus</dt>
          <dd>Athletics, access &amp; daily mobility</dd>
        </div>
      </dl>
      <p class="itinerary-story__visit-status">Aiming for a Winter 2027 visit.</p>
    </section>
    ...
    <section class="itinerary-story__visit-profile itinerary-story__visit-profile--future" id="fillauer-visit">
      <dl class="itinerary-story__facts">
        ...
        <div>
          <dt>Field-note focus</dt>
          <dd>Component design &amp; production</dd>
        </div>
      </dl>
      <p class="itinerary-story__visit-status">Aiming for a Winter 2027 visit.</p>
    </section>
