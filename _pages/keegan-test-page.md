...
<section class="prosthetic-story" id="prosthetic-story" aria-label="Designed for Living">
  <div class="prosthetic-story__sticky">
    <div class="prosthetic-story__content">
      <div class="prosthetic-hand-stage" aria-hidden="true">
        <div class="prosthetic-hand">
          <div class="prosthetic-hand__finger prosthetic-hand__finger--index">
            <i><b><em></em></b></i>
          </div>
          <div class="prosthetic-hand__finger prosthetic-hand__finger--middle">
            <i><b><em></em></b></i>
          </div>
          <div class="prosthetic-hand__finger prosthetic-hand__finger--ring">
            <i><b><em></em></b></i>
          </div>
          <div class="prosthetic-hand__finger prosthetic-hand__finger--little">
            <i><b><em></em></b></i>
          </div>
          <div class="prosthetic-hand__palm"></div>
          <div class="prosthetic-hand__thumb">
            <i></i><b></b>
          </div>
          <div class="prosthetic-hand__wrist"></div>
        </div>
        <div class="prosthetic-hand-stage__shadow"></div>
      </div>
    </div>
...
<section class="keegan-editorial-intro" aria-labelledby="keegan-introduction-title">
  ...
  <h2 id="keegan-introduction-title">Designed for Living</h2>
  <p class="keegan-editorial-intro__subtitle">
  ...
  <p>
    ...
    are created—and how they influence daily life in communities around the world.
  </p>
...
<div id="keegan-map" data-animate-routes aria-label="Interactive map of fellowship destinations"></div>
