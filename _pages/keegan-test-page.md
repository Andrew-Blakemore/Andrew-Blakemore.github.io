...
<section class="prosthetic-story" id="prosthetic-story" aria-label="Designed for Living">
  <div class="prosthetic-story__sticky">
    <div class="prosthetic-story__content">
      <div class="prosthetic-story__copy">
        <h1>Designed for Living</h1>
        <p>Exploring the boundaries of everyday life with modern prosthetics</p>
      </div>

      <div class="prosthetic-assembly" aria-hidden="true">
        <div class="prosthetic-assembly__guide"></div>

        <div class="prosthetic-person">
          <i class="prosthetic-person__head"></i>
          <i class="prosthetic-person__torso"></i>
          <i class="prosthetic-person__arm prosthetic-person__arm--left"></i>
          <i class="prosthetic-person__arm prosthetic-person__arm--right"></i>
          <i class="prosthetic-person__leg"></i>
        </div>

        <div class="prosthetic-part prosthetic-part--socket" data-part="socket">
          <span class="prosthetic-part__label">Socket</span>
          <i class="prosthetic-socket"></i>
        </div>

        <div class="prosthetic-part prosthetic-part--knee" data-part="knee">
          <span class="prosthetic-part__label">Knee unit</span>
          <i class="prosthetic-knee"></i>
        </div>

        <div class="prosthetic-part prosthetic-part--pylon" data-part="pylon">
          <span class="prosthetic-part__label">Pylon</span>
          <i class="prosthetic-pylon"></i>
        </div>

        <div class="prosthetic-part prosthetic-part--foot" data-part="foot">
          <span class="prosthetic-part__label">Foot</span>
          <i class="prosthetic-foot"></i>
        </div>

        <div class="prosthetic-assembly__connections">
          <i></i>
          <i></i>
          <i></i>
        </div>

        <div class="prosthetic-assembly__caption">
          <span>Engineered as a system</span>
          <strong>Designed around a person</strong>
        </div>
      </div>
    </div>
