...
<section class="world-motion" id="world-motion" aria-label="A World in Motion">
  <div class="world-motion__sticky">
    ...
    <div class="world-motion__content">
      <div class="world-motion__copy">
        ...
        <p>Exploring everyday life with modern prosthetics around the globe</p>
      </div>
      ...
      <div class="world-motion__globe" aria-hidden="true">
        ...
        <div class="world-motion__sphere">
          <div class="world-motion__grid">
            <i class="world-motion__latitude world-motion__latitude--one"></i>
            <i class="world-motion__latitude world-motion__latitude--two"></i>
            <i class="world-motion__latitude world-motion__latitude--three"></i>
            <i class="world-motion__longitude world-motion__longitude--one"></i>
            <i class="world-motion__longitude world-motion__longitude--two"></i>
            <i class="world-motion__longitude world-motion__longitude--three"></i>
          </div>

          <div class="world-motion__land world-motion__land--one"></div>
          <div class="world-motion__land world-motion__land--two"></div>
          <div class="world-motion__land world-motion__land--three"></div>

          <div class="world-motion__route">
            <i class="world-motion__route-line"></i>
            <b class="world-motion__stop world-motion__stop--one"></b>
            <b class="world-motion__stop world-motion__stop--two"></b>
            <b class="world-motion__stop world-motion__stop--three"></b>
            <b class="world-motion__stop world-motion__stop--four"></b>
            <b class="world-motion__stop world-motion__stop--five"></b>
          </div>
